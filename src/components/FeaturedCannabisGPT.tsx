...
const FeaturedCannabisGPT = () => {
  ...
  return <div className="mt-10 max-w-4xl mx-auto px-4">
      {/* Premium Badge */}
      ...
      {/* Main Card */}
      <div className={`relative overflow-hidden rounded-2xl border-2 transition-all duration-500 ${isHovered ? 'border-green-400 shadow-[0_0_60px_rgba(34,197,94,0.4)]' : 'border-green-500/40 shadow-[0_0_30px_rgba(34,197,94,0.2)]'}`} style={{
      background: 'linear-gradient(135deg, rgba(20,83,45,0.9) 0%, rgba(6,78,59,0.9) 50%, rgba(20,83,45,0.9) 100%)'
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
          {[...Array(8)].map((_, i) => <Leaf key={i} className={`absolute text-green-400 animate-float`} style={{
          left: `${10 + i * 12}%`,
          top: `${20 + i % 3 * 25}%`,
          width: `${20 + i % 3 * 8}px`,
          height: `${20 + i % 3 * 8}px`,
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-2 mb-5">
                {features.map((feature, index) => <div key={index} className="flex items-center gap-1.5 px-3 py-1.5 bg-black/30 rounded-full border border-green-500/30">
              ...
              {/* Launch Button */}
              <button onClick={handleLaunch} className="group relative inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-green-500/50">
            ...
            <div className="relative">
              <div className="aspect-video rounded-xl overflow-hidden border-2 border-green-500/40 shadow-lg shadow-green-500/20">
                <iframe className="w-full h-full" src="https://www.youtube.com/embed/zGGdCzxFNS4?rel=0&modestbranding=1" title="Cannabis GPT - CCSBA Featured Tool" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen loading="lazy" />
              </div>
